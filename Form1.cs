    ...
    public partial class Form1 : Form
    {
     ...
     static string connString = @"Data Source=" + datasource + ";Initial Catalog="
        ...
        private void Material4(string url, string page, string material)
        {
            ...
            deter = RetreivedPrices(isplitYear2, splitMonth2, splitDay2, skeyword2, _material, test1, 0, 0, 0, "", c, "每週", rec.Substring(0, 10));
            if (deter == true)
            {
            }
            else
            {
             InsertPrices(isplitYear2, splitMonth2, splitDay2, skeyword2, _material, test1, 0, 0, 0, "", c, "每週", rec.Substring(0, 10));
            }
        ...
        private bool RetreivedPrices(int year, string month, string day, string date, string name, string rate1, int rate2, int rate3, int rate4, string memo, double baseprice, string upcircle, string update)
        {
            SqlConnection myConn = new SqlConnection(connString);
        ...
        private void InsertPrices(int year, string month, string day, string date, string name, string rate1, int rate2, int rate3, int rate4, string memo, double baseprice, string upcircle, string update)
        {
            SqlConnection myConn = new SqlConnection(connString);
